...
public class PlayerControlScript : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
        ...
        float a = Input.GetAxis("Fire1");                   // setup a variable as melee
        float s = Input.GetAxis("Fire2");                   // setup s variable as shoot
        anim.SetFloat("Speed", v);							// set our animator's float parameter 'Speed' equal to the vertical input axis				
		anim.SetFloat("Direction", h); 						// set our animator's float parameter 'Direction' equal to the horizontal input axis	
        anim.SetFloat("Attacking", a);                      // set our animator's float parameter 'Attacking' equal to  fire1
        anim.SetFloat("Shooting", s);                       // set our animator's float parameter 'Shooting' equal to  fire2
